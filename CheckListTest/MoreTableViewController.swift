...
class MoreTableViewController: UITableViewController {
    ...
    @IBAction func share() {
        ...
        let qzoneAction = UIAlertAction(title: "QQ空间", style: UIAlertActionStyle.Default) {
            （action）-> Void in
            let newsUrl = NSURL(string: "http://m.weibo.cn/1999818521/DwTeHfRjV")
            let title = "让你的生活从此更加规律"
            let description = "每日计划,一个可以改变自己的APP!"
            let previewImageUrl = NSURL(string: "http://www.dxsbb.com/upFiles/infoImg/2015032876412313.jpg")
        ...
        let weichatAction = UIAlertAction(title: "朋友圈", style: UIAlertActionStyle.Default) {
            ...
            ext.webpageUrl = "http://m.weibo.cn/1999818521/DwTeHfRjV"
